...
%OCR dataset (the '3' dataset in particular)
...
create_diary = true;
if create_diary
    diary_file = [MOCR_PATH, '/results/unlv_3_all.diary'];
    if exist(diary_file)
        delete(diary_file);
    end
    diary(diary_file);
